...
var Query = function (a) {
		...
		var b = function (a) {
				var b = [],
					...
					e,
					f;
				if (typeof a == 'undefined' || a === null || a === '') return b;
				(a.indexOf('?') === 0 && (a = a.substring(1)), (d = a.toString().split(/[&;]/)));
				for (c = 0; c < d.length; c++) ((e = d[c]), (f = e.split('=')), b.push([f[0], f[1]]));
				return b;
			},
			c = b(a),
			d = function () {
				var a = '',
					b,
					d;
				for (b = 0; b < c.length; b++) ((d = c[b]), a.length > 0 && (a += '&'), (a += d.join('=')));
				return a.length > 0 ? '?' + a : a;
			},
			e = function (a) {
				((a = decodeURIComponent(a)), (a = a.replace('+', ' ')));
				return a;
			},
			f = function (a) {
				var b, d;
