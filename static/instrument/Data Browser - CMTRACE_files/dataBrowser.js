...
if (
	yourIp.substring(0, 6) == '134.95' ||
	yourIp.substring(0, 6) == '134.94' ||
	yourIp.substring(0, 7) == '131.220' ||
	yourIp.substring(0, 7) == '140.172'
) {
	var uniNetwork = true;
} else {
...
dataStrings['CMTRACE-2023']['WC_KNMI_vertical_wind'] =
	"'cmtrace/knmi_windcube/'yy'/'mm'/'yymmdd'_KNMI_Windcube_DBS_vertical.png'";

dataStrings['CMTRACE-2023']['WC_KNMI_wind_direction'] =
	"'cmtrace/knmi_windcube/'yy'/'mm'/'yymmdd'_KNMI_Windcube_DBS_winddirection.png'";
dataStrings['CMTRACE-2023']['WC_KNMI_wind_speed'] =
	"'cmtrace/knmi_windcube/'yy'/'mm'/'yymmdd'_KNMI_Windcube_DBS_windspeed.png'";
dataStrings['CMTRACE-2023']['WC_KNMI_overview'] =
	"'cmtrace/knmi_windcube/'yy'/'mm'/'yymmdd'_KNMI_Windcube_vertical_stare.png'";
...
//KNMI-Charts
dataStrings['KNMI']['chart_00'] =
	"'https://cdn.knmi.nl/knmi/map/page/klimatologie/daggegevens/weerkaarten/analyse_'yymmdd'00.gif'";
dataStrings['KNMI']['chart_06'] =
	"'https://cdn.knmi.nl/knmi/map/page/klimatologie/daggegevens/weerkaarten/analyse_'yymmdd'06.gif'";
dataStrings['KNMI']['chart_12'] =
	"'https://cdn.knmi.nl/knmi/map/page/klimatologie/daggegevens/weerkaarten/analyse_'yymmdd'12.gif'";
dataStrings['KNMI']['chart_18'] =
	"'https://cdn.knmi.nl/knmi/map/page/klimatologie/daggegevens/weerkaarten/analyse_'yymmdd'18.gif'";
...
function populateSelect() {
	...
	if (!uniNetwork && hasDisabled[site]) {
		$('select.select').append(
			"<option value='disabled' disabled='disabled'>Some instruments are only accesible from the network of the University of Cologne!</option>"
		);
	}
}
...
$(document).ready(function () {
	...
	if (urlSite) {
		...
		$('select#select' + 'UpperLeft' + ' option[value=' + decodeURI(uri.getQueryParamValue('UpperLeft')) + ']').attr(
			'selected',
			'selected'
		);
		if (noPanels > 1)
			$('select#select' + 'UpperRight' + ' option[value=' + decodeURI(uri.getQueryParamValue('UpperRight')) + ']').attr(
				'selected',
				'selected'
			);
		if (noPanels > 2)
			$('select#select' + 'LowerRight' + ' option[value=' + decodeURI(uri.getQueryParamValue('LowerRight')) + ']').attr(
				'selected',
				'selected'
			);
		if (noPanels > 3)
			$('select#select' + 'LowerLeft' + ' option[value=' + decodeURI(uri.getQueryParamValue('LowerLeft')) + ']').attr(
				'selected',
				'selected'
			);
