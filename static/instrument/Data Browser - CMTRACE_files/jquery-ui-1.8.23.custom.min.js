						...
						? (b = this.parents()
								.filter(function () {
									return (
										...
										/(auto|scroll)/.test(
											a.curCSS(this, 'overflow', 1) + a.curCSS(this, 'overflow-y', 1) + a.curCSS(this, 'overflow-x', 1)
										)
									);
								})
								.eq(0))
	...
	(a(document).mouseup(function (a) {
		...
		a.widget('ui.mouse', {
			...
			_mouseDistanceMet: function (a) {
				return (
					Math.max(Math.abs(this._mouseDownEvent.pageX - a.pageX), Math.abs(this._mouseDownEvent.pageY - a.pageY)) >=
	...
	(a.widget('ui.dialog', {
		...
		moveToTop: function (b, c) {
			...
			return (e.modal && !b) || (!e.stack && !e.modal)
				...
				: (e.zIndex > a.ui.dialog.maxZ && (a.ui.dialog.maxZ = e.zIndex),
					d.overlay &&
						((a.ui.dialog.maxZ += 1), d.overlay.$el.css('z-index', (a.ui.dialog.overlay.maxZ = a.ui.dialog.maxZ))),
		...
		a.extend(a.ui.dialog.overlay, {
			...
			create: function (b) {
				...
				var c = (this.oldInstances.pop() || a('<div></div>').addClass('ui-widget-overlay'))
					.appendTo(document.body)
			...
			resize: function () {
				...
				(a.each(a.ui.dialog.overlay.instances, function () {
					...
					b
						...
						.css({ width: a.ui.dialog.overlay.width(), height: a.ui.dialog.overlay.height() }));
			}
		}),
	...
	($.extend(Datepicker.prototype, {
		...
		_dialogDatepicker: function (a, b, c, d, e) {
			...
			if (!f) {
				...
				var g = 'dp' + this.uuid;
				((this._dialogInput = $(
					'<input type="text" id="' + g + '" style="position: absolute; top: -100px; width: 0px;"/>'
				)),
				...
				switch (a.keyCode) {
					...
					case 33:
						$.datepicker._adjustDate(
							a.target,
							a.ctrlKey ? -$.datepicker._get(b, 'stepBigMonths') : -$.datepicker._get(b, 'stepMonths'),
							'M'
						);
						break;
					case 34:
		...
		_hideDatepicker: function (a) {
			...
			if (this._datepickerShowing) {
				...
				($.effects && $.effects[c]
					...
					: b.dpDiv[c == 'slideDown' ? 'slideUp' : c == 'fadeIn' ? 'fadeOut' : 'hide'](c ? d : null, e),
					c || e(),
					(this._datepickerShowing = !1));
		...
		parseDate: function (a, b, c) {
			...
			i == -1
				...
				: i < 100 && (i += new Date().getFullYear() - (new Date().getFullYear() % 100) + (i <= d ? 0 : -100));
			if (l > -1) {
				((j = 1), (k = l));
				do {
		...
		_generateHTML: function (a) {
			...
			var c = this._get(a, 'isRTL'),
				...
				k = this._daylightSavingAdjust(
					a.currentDay ? new Date(a.currentYear, a.currentMonth, a.currentDay) : new Date(9999, 9, 9)
				),
			...
			for (var L = 0; L < g[0]; L++) {
				...
				for (var N = 0; N < g[1]; N++) {
					...
					(n++,
						...
						(Q +=
							'</tbody></table>' +
							(j ? '</div>' + (g[0] > 0 && N == g[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : '') : '')),
						(M += Q));
				}
				K += M;
			}
